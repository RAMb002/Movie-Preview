...
class MediasView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: const EdgeInsets.fromLTRB(kPadding, 16, kPadding, 16),
      child: Column(
          ...
          ConstrainedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                String heroTag = "${media.title.toString()} ${label.toLowerCase()}";
                Widget child = Hero(
                  tag: heroTag,
                  child: MediaCover(
                    width: _mediaWidth,
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => Provider<Shows>.value(
                          value: media,
                          child:  MovieDetails(media: media,label: _label,),
                        ),
                      ),
                    );
                  },
