...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<Widget> _buildButtonBar(List<String> labels,bool bigScreen) {
    ...
    for (var i = 0; i < labels.length; i++) {
      ...
      Widget tabTile = Padding(
        ...
        child: Container(
          ...
          child: ElevatedButton(
            ...
            child: Padding(
              padding: _padding.add( EdgeInsets.symmetric(horizontal:bigScreen ? 16 : 0)),
              child: Text(
                labels[i],
      ...
      Widget child =bigScreen ? tabTile : Expanded(
        flex: isButtonSelected ? 4 : 3,
        child: tabTile,
      );
      _buttons.add(child);
    }
      ...
      children: [
        Padding(
          ...
          ButtonBar(
            ...
            children: _buildButtonBar(['Movies', 'Shows', 'Music'],bigScreen),
          ) :
          Row(
